...
public final class Constants
{
    ...
    public static final float SCREEN_SIZE_X = (Gdx.graphics.getWidth() - 192) / SCALE / PPM;
    ...
    public static final float SCREEN_SIZE_Y = (Gdx.graphics.getHeight() - 108) / SCALE / PPM;
