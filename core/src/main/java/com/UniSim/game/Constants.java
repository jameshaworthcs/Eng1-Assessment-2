...
public final class Constants
{
    ...
    public static final float CHARACTER_SPEED = 10000;// Movement speed in pixels per second
    ...
    public static final float SCREEN_SIZE_Y = (Gdx.graphics.getHeight() - 100) / SCALE;
